					...
					<span class="menu"> </span>
						<ul>
							...
							<li class="active"><div class="logo">
							 ...
							 -->
							<li class="active"><a href="index.html"><img src="./resources/images/logo.png" alt="" ></a></li>
							<li><a href="events.html" data-hover="메뉴1" >메뉴1</a></li>
							<li><a href="404.html" data-hover="메뉴2">메뉴2</a></li>
							<li><a href="contact.html" data-hover="메뉴3">메뉴3</a></li>
						</ul>
						<!--script-->
					<script>
